...
sheets = pd.read_excel('c:/dev/workspace/data-processing/bvb_fahrgastzahlen/data_orig/fahrgast.xlsx', sheet_name=None , engine='openpyxl',  header=None)
dat_sheet_names = []
for key in sheets:
...
for sheet_name in dat_sheet_names:
    zeitreihe_x = pd.read_excel('c:/dev/workspace/data-processing/bvb_fahrgastzahlen/data_orig/fahrgast.xlsx', sheet_name=sheet_name , engine='openpyxl', header=None).T
...
fahrgast.to_csv('c:/dev/workspace/data-processing/bvb_fahrgastzahlen/data/bvb_fahrgastzahlen.csv', index = False)
