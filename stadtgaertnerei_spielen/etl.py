...
def main():
    ...
    df_spielplaetze["spielgeraete_url"] = "https://data.bs.ch/explore/dataset/100463/?refine.spielplatz_id=" + df_spielplaetze.loc[df_spielplaetze["id"].notna(), "id"].astype(int).astype(str)
    ...
    df_spielgeraete.loc[df_spielgeraete["spielplatz_id"].notna(), "spielplatz_url"] = "https://data.bs.ch/explore/dataset/100462/?refine.id=" + df_spielgeraete.loc[df_spielgeraete["spielplatz_id"].notna(), "spielplatz_id"].astype(int).astype(str)
