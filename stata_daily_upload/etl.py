...
def main():
    uploads = [{'file': 'StatA/Bevoelkerung/sterbefaelle.csv', 'dest_dir': 'bevoelkerung', 'ods_id': '100079'},
               ...
               {'file': 'StatA/Quartierradar/quartierradar_ogd_long.csv', 'dest_dir': 'quartierradar', 'ods_id': '100226'},
               ...
               {'file': 'StatA/Bevoelkerung/Schutzsuchende.csv', 'dest_dir': 'bevoelkerung', 'ods_id': '100225'},
               {'file': 'StatA/witterung/Witterungserscheinungen.xlsx', 'dest_dir': 'witterung', 'ods_id': '100227'}
               ]
