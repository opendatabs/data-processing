...
def main():
    ...
    df = pd.concat([common.pandas_read_csv(f, skiprows=range(1, 6), sep=';', encoding='cp1252') for f in glob.glob('/Users/jonasbieri/PycharmProjects/data-processing/lufthygiene_pm25/archive/*.csv')], ignore_index=True)
    print(f'Sorting...')
