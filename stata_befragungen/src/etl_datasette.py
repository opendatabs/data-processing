...
def main():
    datasets = [
        {
            'data_file': os.path.join(credentials.data_path, '55plus/2023/Daten_Befragung_55_plus_2023.csv'),
            'var_file': os.path.join(credentials.data_path, '55plus/2023/Variablen_Befragung_55_plus_2023.csv'),
            'export_folder': '55plus/datasette',
            'export_file': 'Befragung_55plus_2023.db',
            'ftp_folder': '55plus',
        },
        {
            'data_file': os.path.join(credentials.data_path, '55plus/2019/Daten_Befragung_55_plus_2019.csv'),
            'var_file': os.path.join(credentials.data_path, '55plus/2019/Variablen_Befragung_55_plus_2019.csv'),
            'export_folder': '55plus/datasette',
            'export_file': 'Befragung_55plus_2019.db',
            'ftp_folder': '55plus',
        },
        {
            'data_file': os.path.join(credentials.data_path, '55plus/2015/Daten_Befragung_55_plus_2015.csv'),
            'var_file': os.path.join(credentials.data_path, '55plus/2015/Variablen_Befragung_55_plus_2015.csv'),
            'export_folder': '55plus/datasette',
            'export_file': 'Befragung_55plus_2015.db',
            'ftp_folder': '55plus',
        },
        {
            'data_file': os.path.join(credentials.data_path, '55plus/2011/Daten_Befragung_55_plus_2011.csv'),
            'var_file': os.path.join(credentials.data_path, '55plus/2011/Variablen_Befragung_55_plus_2011.csv'),
            'export_folder': '55plus/datasette',
...
def convert_to_sqlite(data_file, var_file, export_folder, export_file, ftp_folder):
    if ct.has_changed(data_file):
        ...
        # Create a connection
        export_path = os.path.join(credentials.data_path, export_folder, export_file)
