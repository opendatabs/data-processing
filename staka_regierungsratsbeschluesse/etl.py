...
def _():
    ...
    return BeautifulSoup, common, datetime, load_dotenv, logging, os, pd, re
...
def _(load_dotenv, os):
    ...
    return BASE_URL, DATA_PATH, DETAIL_PREFIX, LISTING_URL


@app.cell
def _(BASE_URL, BeautifulSoup, LISTING_URL, common, logging, re):
    def scrape_sitzung_overview(page_number, just_process_last_sitzung=False):
        ...
        return detail_urls
    return (scrape_sitzung_overview,)


@app.cell
def _(BASE_URL, BeautifulSoup, common, datetime, logging):
