...
def main():
    logging.info(f'Downloading data from FTP server...')
    common.download_ftp([credentials.data_orig], credentials.ftp_server, credentials.ftp_user, credentials.ftp_pass, credentials.ftp_remote_path, credentials.local_path, '')
