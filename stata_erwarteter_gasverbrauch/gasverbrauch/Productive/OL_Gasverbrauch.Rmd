---
title: "Erwarteter Gasverbrauch im Kanton Basel-Stadt"
authors: "José A.F. Monteiro, Joëlle Velvart und Tobias Erhardt"
...
tab_train %>%
  mutate(Ettape = "training") %>%
  bind_rows(tab_test %>%
              mutate(Ettape = "testing")) %>%
