...
class TestCheckIfEmail(object):
    def test_all_is_filled_before_10(self):
        ...
        actual_return = check_if_email(df_log=test_argument, date=date(2022, 1, 28), day="today", now_in_switzerland=time(9,15),
    ...
    def test_missing_after_time_for_email(self):
        ...
        actual_return = check_if_email(df_log=test_argument, date=date(2022, 1, 28), day="today", now_in_switzerland=time(9,35),
                                       time_for_email=time_for_email, time_for_email_to_call=time_for_email_to_call, time_for_email_final_status=time_for_email_final_status)
        pd.testing.assert_frame_equal(expected_return, actual_return)
    ...
    def test_missing_after_time_to_call(self):
        ...
        actual_return = check_if_email(df_log=test_argument, date=date(2022, 1, 28), day="today", now_in_switzerland=time(9,51),
                                       time_for_email=time_for_email, time_for_email_to_call=time_for_email_to_call, time_for_email_final_status=time_for_email_final_status)
        pd.testing.assert_frame_equal(expected_return, actual_return)
    ...
    def test_all_filled_after_10(self):
        ...
        actual_return = check_if_email(df_log=test_argument, date=date(2022, 1, 28), day="today", now_in_switzerland=time(10,10),
                                       time_for_email=time_for_email, time_for_email_to_call=time_for_email_to_call, time_for_email_final_status=time_for_email_final_status)
        pd.testing.assert_frame_equal(expected_return, actual_return)
    ...
    def test_not_all_filled_after_10(self):
        ...
        actual_return = check_if_email(df_log=test_argument, date=date(2022, 1, 28), day="today",  now_in_switzerland=time(10,15),
                                       time_for_email=time_for_email, time_for_email_to_call=time_for_email_to_call, time_for_email_final_status=time_for_email_final_status)
        pd.testing.assert_frame_equal(expected_return, actual_return)
    ...
    def test_missing_saturday(self):
        ...
        actual_return = check_if_email(df_log=test_argument, date=date(2022, 1, 22), day="Saturday", now_in_switzerland=time(9,10),
                                       time_for_email=time_for_email, time_for_email_to_call=time_for_email_to_call, time_for_email_final_status=time_for_email_final_status)
        pd.testing.assert_frame_equal(expected_return, actual_return)
    ...
    def test_missing_sunday(self):
        ...
        actual_return = check_if_email(df_log=test_argument, date=date(2022, 1, 30), day="Sunday", now_in_switzerland=time(9,10),
                                       time_for_email=time_for_email, time_for_email_to_call=time_for_email_to_call, time_for_email_final_status=time_for_email_final_status)
        pd.testing.assert_frame_equal(expected_return, actual_return)
    ...
    def test_missing_after_time_for_email_weekend(self):
        ...
        actual_return = check_if_email(df_log=test_argument, date=date(2022, 1, 24), day="today", now_in_switzerland=time(9,35),
                                       time_for_email=time_for_email, time_for_email_to_call=time_for_email_to_call, time_for_email_final_status=time_for_email_final_status)
        pd.testing.assert_frame_equal(expected_return, actual_return)
    ...
    def test_all_is_filled_before_10_weekend(self):
        ...
        actual_return = check_if_email(df_log=test_argument, date=date(2022, 1, 24), day="today", now_in_switzerland=time(9,15),
                                       time_for_email=time_for_email, time_for_email_to_call=time_for_email_to_call, time_for_email_final_status=time_for_email_final_status)
        pd.testing.assert_frame_equal(expected_return, actual_return)
