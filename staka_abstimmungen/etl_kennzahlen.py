...
def calculate_kennzahlen(data_file_names):
    ...
    for data_file_name in data_file_names:
        ...
        print("Cleaning up Gemeinde names in all_df...")
        wahllok_replacements = {
            "Total Basel": "Basel",
            "Total Riehen": "Riehen",
        ...
        df_merged = reduce(
            lambda left, right: pd.merge(left, right, on=["Gemein_Name"], how="inner"),
            frames_to_join,
        )
    ...
    concatenated_df["id"] = (
        ...
        + "_"
        + concatenated_df["Gemein_ID"].astype(int).astype(str).str.zfill(2)
    )
